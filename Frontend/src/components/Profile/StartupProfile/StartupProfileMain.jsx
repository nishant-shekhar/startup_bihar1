  ...
  const checkFormStatus = async (newPanel) => {
    ...
    try {
      ...
      if (newPanel === "StartupForm") {
        apiUrl = "http://51.20.148.118:3007/api/StartupProfile/user-document";
      } else if (newPanel === "SeedFund") {
        apiUrl = "http://51.20.148.118:3007/api/seed-fund/status";
      } else if (newPanel === "PostSeed") {
        apiUrl = "http://51.20.148.118:3007/api/post-seed/status";
      } else if (newPanel === "SecondTranche") {
        apiUrl = "http://51.20.148.118:3007/api/second-tranche/status";
      }
