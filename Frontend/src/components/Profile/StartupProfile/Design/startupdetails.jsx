...
const Startupdetails = ({ founderimage, companyname, year }) => {
    ...
    const fetchDetails = async () => {
      try {
        const response = await axios.get(
          `https://startupbihar.in:3007/api/userlogin/startup-details?user_id=${localStorage.getItem('user_id')}`
        );
  ...
  const handleFileChange = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await axios.put('https://startupbihar.in:3007/api/userlogin/update-logo', formData, {
          headers: {
  ...
  const handleUpdate = async (field, value) => {
    const urlMap = {
      moto: 'https://startupbihar.in:3007/api/userlogin/update-moto',
      twitter: 'https://startupbihar.in:3007/api/userlogin/update-twitter',
      facebook: 'https://startupbihar.in:3007/api/userlogin/update-facebook',
      instagram: 'https://startupbihar.in:3007/api/userlogin/update-instagram',
      linkedin: 'https://startupbihar.in:3007/api/userlogin/update-linkedin',
      website: 'https://startupbihar.in:3007/api/userlogin/update-website',
    };
