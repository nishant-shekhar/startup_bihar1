...
const Startupdetails = ({ founderimage, companyname, year }) => {
  ...
  const handleFileChange = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await axios.put('https://localhost:3007/api/userlogin/update-logo', formData, {
          headers: {
  ...
  const handleUpdate = async (field, value) => {
    const urlMap = {
      moto: 'https://localhost:3007/api/userlogin/update-moto',
      twitter: 'https://localhost:3007/api/userlogin/update-twitter',
      facebook: 'https://localhost:3007/api/userlogin/update-facebook',
      instagram: 'https://localhost:3007/api/userlogin/update-instagram',
      linkedin: 'https://localhost:3007/api/userlogin/update-linkedin',
      website: 'https://localhost:3007/api/userlogin/update-website',
    };
