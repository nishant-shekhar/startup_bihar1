    ...
    <div className="mx-auto w-full max-w-5xl">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <InfoCard label="Applicant Name" value={formData?.userSignup?.fullName || "-"} />
          <InfoCard label="Post Applied For" value={formData?.personalDetails?.postAppliedFor || "-"} />
          ...
          <InfoCard label="Category" value={formData?.personalDetails?.category || "-"} />
        ...
        <div className="mt-6 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>This is a system-generated receipt and does not imply selection or approval.</li>
            <li>Use the registration number in all future communication with Startup Bihar SSU.</li>
          </ul>
        </div>
      </div>
    </div>
