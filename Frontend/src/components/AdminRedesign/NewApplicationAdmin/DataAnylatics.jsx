          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="px-6 py-4 text-sm font-medium text-gray-700 uppercase tracking-wider">Batch</th>
                <th className="px-6 py-4 text-sm font-medium text-gray-700 uppercase tracking-wider">Total Applications</th>
                <th className="px-6 py-4 text-sm font-medium text-gray-700 uppercase tracking-wider">Accepted</th>
              </tr>
            </thead>
            <tbody
  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 pb-10">
        <div className="bg-white/70 border border-blue-200 rounded-3xl p-6 drop-shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:shadow-xl transition-shadow">
