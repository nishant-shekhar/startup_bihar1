...
const AdminLeftbar = ({ changePanel }) => {
  ...
  const categorizedMenu = [
    ...
    {
      category: 'Startup Application Module',
      items: [
        { label: 'Startup Application', icon: <FilePlus size={16} strokeWidth={1.5}/>, badge: '12' },
        ...
        { label: 'AI Reviewed Data New', icon: <Bot size={16} strokeWidth={1.5}/>, badge: 'Beta' },
        ...
        { label: 'Assign PI Marks', icon: <ClipboardCheck size={16} strokeWidth={1.5}/>, badge: null },
  ...
  return (
    <aside className="w-full md:w-64 h-screen bg-white flex flex-col border-r border-gray-50">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-5 hide-scrollbar">
        {/* Header Section - Scrollable with menu */}
