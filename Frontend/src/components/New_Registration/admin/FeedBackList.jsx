      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <InfoPill icon={<Building2 size={14} />} label="Application ID" value={item._applicationId} />
            <InfoPill icon={<User2 size={14} />} label="Founder" value={getFounderName(item)} />
            <InfoPill icon={<CalendarDays size={14} />} label="Submitted On" value={formatDate(feedback?.submittedAt)} />
...
export default function FeedbackList({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[140] flex items-center justify-center bg-slate-950/65 p-3 backdrop-blur-md md:p-6">
      <div className="relative max-h-[94vh] w-full max-w-6xl overflow-hidden rounded-[38px] border border-white/20 bg-[#f8fafc] shadow-[0_40px_120px_rgba(2,6,23,0.42)]">
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  View all website feedback entries in one place.
                </p>
              </div>
