...
const IncubationModule = ({ onProfileClick }) => {
		...
		const fetchData = async () => {
			try {
				const response = await axios.get(
					"https://startupbihar.in:3007/api/startupProfile/list",
				);
	...
	return (
		...
		>
			<h1 className="pl-5 pt-8 text-2xl pb-4">Incubation Module</h1>
...
export default IncubationModule;
