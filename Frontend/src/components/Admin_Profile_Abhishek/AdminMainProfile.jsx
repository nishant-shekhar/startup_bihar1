		...
		switch (activePage) {
			...
			case "StartupProfile":
				return (
					<CommonList
						...
						url="https://localhost:3007/api/StartupProfile/v2"
			...
			case "SeedFundModule":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/seed-fund/v2"
			...
			case "SecondTrancheModule":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/second-tranche/v2"
			...
			case "PostSeedFundModule":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/post-seed/v2"
			...
			case "QPRModule":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/Qreport/v2"
						title="QPR List"
						type="Qreport"
					/>
				);
			...
			case "MatchingLoan":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/matchingLoan/v2"
						title="Post Seed Application List"
						type="matchingLoan"
					/>
				);
			case "IncubationModule":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/incubation/v2"
			...
			case "AccelerationProgrammeModule":
				return (
					<CommonList
						onSelect={handleSelect}
						url="https://localhost:3007/api/acceleration/v2"
						title="Post Seed Application List"
						type="acceleration"
					/>
				);
